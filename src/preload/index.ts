...
const api: ApplicationAPI = {
  ...
  saveTask: (baseDir, name, id) => ipcRenderer.invoke('save-task', baseDir, name, id),
  deleteTask: (baseDir, id) => ipcRenderer.invoke('delete-task', baseDir, id),
  loadTask: (baseDir, name) => ipcRenderer.invoke('load-task', baseDir, name),
  getTasks: (baseDir) => ipcRenderer.invoke('get-tasks', baseDir),
  exportTaskToMarkdown: (baseDir) => ipcRenderer.invoke('export-session-to-markdown', baseDir),
