...
export const UsageTable = ({ data, groupBy }: Props) => {
  ...
  const columns: Column<UsageDataRow>[] = [
    ...
    },
    {
      ...
      align: 'right',
      sort: (a, b) => (a.input_tokens || 0) - (b.input_tokens || 0),
    },
    {
      ...
      cell: (value) => (value as number) || 0,
      align: 'right',
      sort: (a, b) => (a.output_tokens || 0) - (b.output_tokens || 0),
    },
    {
      ...
      cell: (value) => (value as number) || 0,
      align: 'right',
      sort: (a, b) => (a.cache_read_tokens || 0) - (b.cache_read_tokens || 0),
    },
    {
    ...
    },
    {
      ...
      align: 'right',
      sort: (a, b) => (a.input_tokens || 0) + (a.output_tokens || 0) - ((b.input_tokens || 0) + (b.output_tokens || 0)),
    },
    {
      accessor: 'cost',
