import { EditFormat, Mode, Model, ModelsData, RawModelInfo, TaskData, WorkingMode } from '@common/types';
...
export const TaskBar = React.forwardRef<TaskBarRef, Props>(
  ({ baseDir, task, modelsData, mode, onModelsChange, runCommand, onToggleSidebar, onWorkingModeChange }, ref) => {
