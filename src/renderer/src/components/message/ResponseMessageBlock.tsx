...
export const ResponseMessageBlock = ({ baseDir, message, allFiles, renderMarkdown, compact = false, onRemove }: Props) => {
  ...
  return (
    ...
    >
      ...
      {!compact && <MessageBar content={message.content} usageReport={message.usageReport} remove={onRemove} />}
    </div>
  );
};
