...
export const BMAD_WORKFLOWS: WorkflowMetadata[] = [
  ...
  // Quick Phase
  {
    ...
    totalSteps: 4,
    followUps: ['quick-dev', 'create-story'],
  },
  {
    id: 'quick-dev',
    name: 'Quick Dev',
    ...
    requiredArtifacts: ['_bmad-output/planning-artifacts/quick-spec*.md'],
    outputArtifact: '_bmad-output/implementation-artifacts/quick-dev*.md',
    totalSteps: 6,
    followUps: ['create-story'],
  },
];
